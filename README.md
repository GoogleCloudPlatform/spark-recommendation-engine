...
Make sure to update your database values in the [main.py](appengine/app/main.py) file to match your setup. If you kept the values of the .sql script, _DB_NAME = 'recommendation_spark'. The rest will be specific to your setup.
